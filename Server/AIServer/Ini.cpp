...
int CIni::GetProfileInt(const char* lpAppName,
...
char* CIni::GetProfileString(const char* lpAppName,
	const  char* lpKeyName,
...
int CIni::SetProfileInt(const char* lpAppName,
	const  char* lpKeyName,
							  int nDefault)
{
	int nRet  = -1;
...
int CIni::SetProfileString(const char* lpAppName,
	const   char* lpKeyName,
	const   char* lpDefault)
{
	int nRet  = -1;
